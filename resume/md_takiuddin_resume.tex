...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item Built Redis Streams + Kafka event propagation system for high-throughput event delivery
  \item Extended drag-and-drop orchestration engine with reusable action blocks, reducing legal-ops turnaround from days to hours
  \item Optimized SQLAlchemy queries with CTEs and proper indexing, significantly improving contract-search latency
...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item \textbf{AI \& Data:} PydanticAI, FastMCP (MCP servers), pgvector, LangChain, scikit-learn, pandas, NumPy, Elasticsearch (BM25, k-NN)
\end{itemize}
